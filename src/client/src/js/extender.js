        ...
        (function waitForEspo() {
            if (typeof self.Espo !== "undefined") {
                ...
                self.Espo.loader.setViewExtensionMap({
                    "views/record/detail-bottom": ["comments:extensions/views/record/detail-bottom"],
                    "views/admin/entity-manager/edit": ["comments:extensions/views/admin/entity-manager/edit"],
                    "views/admin/layouts/bottom-panels-detail": ["comments:extensions/views/admin/layouts/bottom-panels-detail"],
                });
            } else {
